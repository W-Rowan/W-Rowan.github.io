...
Previously, I was a Research Fellow at the University of York on a **£1.8M Innovate UK project** with [dock10](https://www.dock10.co.uk) (the UK's largest television studio facility, based at MediaCityUK) and 2LE Media, developing 3D reconstruction techniques for real-time virtual production (2024–2025). I also secured a **£20,000 grant** from the AI SuperConnector startup accelerator at Imperial College London, and organised the workshop *"Capturing Reality and Changing It"* at the 2024 Locarno Film Festival.
